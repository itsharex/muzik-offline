...
const AllTracks = () => {
    ...
    return (
        ...
        exit={{scale: 0.9, opacity: 0}}>
            ...
            <DeleteSongModal isOpen={state.isDeleteSongModalOpen} title={state.songMenuToOpen ? state.songMenuToOpen.title : ""} closeModal={() => closeDeleteSongModal(dispatch, state.songMenuToOpen)} />
        </motion.div>
    )
}
